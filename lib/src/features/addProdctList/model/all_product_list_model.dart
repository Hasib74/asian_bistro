...
class AllProductListModel {
  ...
  AllProductListModel.fromJson(dynamic json) {
    var _res = isFood ? json['response'] : json["message"];

    print("Is food 2? ${isFood}");
...
class Response {
  Response({
    ...
    var offerAmount,
    var isActive,
    var summerOfferStatus,
    var winterOfferStatus,
  }) {
  ...
  Response.fromJson(dynamic json) {
    print("Is food 3? ${json['description']}");
    _productNameId =
    isFood ? json['product_name_id'] : json["grocery_product_id"];
    _productName = isFood ? json['product_name'] : json["grocery_product_name"];
    _code = json['code'];
    _description = json['description'];
    _price = json['price'];
    _quantity = json['quantity'];
    _imagePath = isFood ? json['imagePath'] : json["image"];
    _productTypeId =
    isFood ? json['product_type_id'] : json["grocery_product_type_id"];
  ...
  var _offerAmount;
  var _isActive;
  var _summerOfferStatus;
  var _winterOfferStatus;
  ...
  get productNameId => _productNameId;
  ...
  get productTypeId => _productTypeId;

  get offerAmount => _offerAmount;

  get isActive => _isActive;

  get summerOfferStatus => _summerOfferStatus;

  get winterOfferStatus => _winterOfferStatus;
